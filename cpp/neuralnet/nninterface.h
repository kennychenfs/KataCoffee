...
namespace NeuralNet {
  ...
  // Preconditions:
  // buffers inputBufs[nIdx]->{rowSpatial,rowGlobal} have been filled with input data for all values of nIdx in
  // [0,numBatchEltsFilled-1] outputs has length numBatchEltsFilled containing allocated but possibly-uninitialized
  // NNOutput structs.
