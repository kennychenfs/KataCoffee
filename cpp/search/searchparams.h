...
struct SearchParams {
  ...
  bool fpuParentWeightByVisitedPolicy;  // For fpu, blend between parent average and parent nn value based on proportion
                                        // of policy visited.
  double fpuParentWeightByVisitedPolicyPow;  // If fpuParentWeightByVisitedPolicy, what power to raise the proportion of
                                             // policy visited for blending.
  ...
  int graphSearchRepBound;  // Rep bound to use for graph search transposition safety. Higher will reduce transpositions
                            // but be more safe.
  double graphSearchCatchUpLeakProb;  // Chance to perform a visit to deepen a branch anyways despite being behind on
                                      // visit count.
  // double graphSearchCatchUpProp; //When sufficiently far behind on visits on a transposition, catch up extra by
  // adding up to this fraction of parents visits at once.
