...
struct Search {
  ...
  bool getPolicySurpriseAndEntropy(
    double& surpriseRet,
    double& searchEntropyRet,
    double& policyEntropyRet,
  ...
  std::vector<double> getAverageTreeOwnership(const Player perspective, const SearchNode* node, int symmetry) const;
  std::pair<std::vector<double>, std::vector<double>>
  getAverageAndStandardDeviationTreeOwnership(const Player perspective, const SearchNode* node, int symmetry) const;
 ...
 private:
  ...
  // LCB helpers
  void getSelfUtilityLCBAndRadius(
  ...
  void applyRecursivelyPostOrderMulithreaded(
    ...
    std::function<void(SearchNode*, int)>* f);
  void applyRecursivelyPostOrderMulithreadedHelper(
    ...
    std::function<void(SearchNode*, int)>* f);
  void applyRecursivelyAnyOrderMulithreaded(
    const std::vector<SearchNode*>& nodes,
    std::function<void(SearchNode*, int)>* f);
